...
function getParagraph(paragraph) {
	return paragraph.join(sentence_separator);
}
...
function joinVotes(vote_hit) {
	...
	var grammar_votes = get_vote(hit.assignments, function(answer) { return answer.grammar; });
	var meaning_votes = get_vote(hit.assignments, function(answer) { return answer.meaning; });
	//print('grammar');
