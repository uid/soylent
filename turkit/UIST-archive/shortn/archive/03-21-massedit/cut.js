var search_reward = 0.10;
var search_redundancy = 5;

var edit_reward = 0.10;
...
function requestPatches() {
	print("TODO: javascript to ensure they mark something using [[double brackets]]");
...
function generatePatchSuggestions(assignments) {
	...
	for (var i=0; i<assignments.length; i++) {
		var user_paragraph = assignments[i].answer.newText;
		var brackets = /\[\[(.*?)\]\]/g;
