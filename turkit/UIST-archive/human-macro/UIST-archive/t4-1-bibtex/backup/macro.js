...
var instructions = "Please tell me how to make this paragraph communicate better. Say what's wrong, and what I can improve. Thanks!";
var reward = 0.15
var redundancy = 5;
var title = "Critique paragraph";
var subtitle = "Please tell me how to make this paragraph communicate better.";
*/
...
var instructions = "In the following text, there are 3 phrases in brackets. These phrases each reference papers I'm looking for, but can't find. What I need are BibTeX citations for the papers described in each of the three brackets.<br/><br/>I suggest using Google Scholar (http://scholar.google.com/) to find the paper and then using the Import to BibTeX feature in the Scholar Preferences.<br/><br/>BibTeX: http://en.wikipedia.org/wiki/BibTeX";
var reward = 0.40;
var redundancy = 5;
var title = "BibTeX Citations";
var subtitle = "I need BibTeX citations for the papers described in each of three brackets.";
...
function requestWork(input) {
	...
	var hitId = mturk.createHIT({
		...
		reward : reward,
		autoApprovalDelayInSeconds : 60 * 10,	// 10 min
