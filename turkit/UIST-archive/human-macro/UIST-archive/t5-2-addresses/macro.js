...
var instructions = (<div>Please complete the addresses below to include all informtion needed as in example below.<br/>please search the internet for the exact address for all missing information.<br/>
Note: States should be the 2 char abbreviation, not the full name.

</div>).toXMLString();
var reward = 0.05;
var redundancy = 5;
var title = "Please complete the addresses below to include all informtion needed as in example below.";
var subtitle = "Please search the internet for the exact address for all missing information.";
