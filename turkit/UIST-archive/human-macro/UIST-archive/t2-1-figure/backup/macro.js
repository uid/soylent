...
var reward = 0.10;
var redundancy = 4;
var title = "Change tense of paragraph";
var subtitle = "Change the verb tense of this paragraph from past to present.";
var instructions = "Change the verb tense of this paragraph from past to present.  For instance, the first few words should change from I GAVE one final glance to I GIVE one final glance.  This needs to be done for every verb in the paragraph; nothing else needs to be changed.";
*/
...
var reward = 0.20
var redundancy = 4;
var title = "Find me a Creative Commons image that describes this paragraph<br/>";
var subtitle = "I need to illustrate a paragraph with an image<br/>";
var instructions = "Pick out keywords from the paragrah like Yosemite, rock, half dome, park<br/>" +
					"Go to a site which hsa CC licensed images such as (flickr, wikipedia) and search for those terms.<br/>"+
					"Find an image that describes the text in the paragraph.<br/>"+
					"Alternatively, you can use CC options in search engines like Google, Yahoo or a CC licnesed content search engine such as Spinxpress to find the image<br/>";
