...
var reward = 0.20
var redundancy = 4;
var title = "Creative Commons Figure";
var subtitle = "Find an image that is relevant to the text in the provided paragraph, and provide a link to that image.";
var instructions = "Find an image that is relevant to the text in the provided paragraph, and provide a link to that image.  Image must be a creative commons figure, and worker should provide proof of the creative commons status.";
